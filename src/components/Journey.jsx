...
export default function Journey() {
    const timelineItems = [
        ...
        {
            title: 'Advanced TypeScript, Electron, React & FastAPI',
            period: '2025 - 2026',
            description: 'Building cross-platform desktop applications with Electron and React, coupled with high-performance FastAPI backends. Implementing advanced TypeScript patterns and real-time features.',
            icon: 'fas fa-chart-line',
            skills: [
                { name: 'TypeScript', icon: 'fab fa-js', iconType: 'fab' },
                { name: 'Electron', icon: 'fas fa-desktop', iconType: 'fas' },
                { name: 'React', icon: 'fab fa-react', iconType: 'fab' },
                { name: 'FastAPI', icon: 'fas fa-bolt', iconType: 'fas' },
                { name: 'Python', icon: 'fab fa-python', iconType: 'fab' },
                { name: 'WebSockets', icon: 'fas fa-exchange-alt', iconType: 'fas' }
            ]
        }
    ]

    return (
        <section id="journey" className="relative z-[15] py-20 px-4">
